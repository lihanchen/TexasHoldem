 ...
 * 
 * @author kevin, modified by me
 */
public class MyTextField extends AbstractComponent {
	...
	// I added this stuff: /////////////////////////////////////////////////
	/** True if only numerals are accepted */
	private boolean numeralsOnly = false;
	
	/** listener for when the string changes*/
	private ComponentListener onTextChangeListener;
	
	public ComponentListener getOnTextChangeListener() {
		return onTextChangeListener;
	}

	public void setOnTextChangeListener(ComponentListener onTextChangeListener) {
		this.onTextChangeListener = onTextChangeListener;
	}

	public boolean isNumeralsOnly() {
		return numeralsOnly;
	}

	public void setNumeralsOnly(boolean numeralsOnly) {
		this.numeralsOnly = numeralsOnly;
	}
	////////////////////////////////////////////////////////////////////////////////////
	 ...
	 */
	public MyTextField(GUIContext container, Font font, int x, int y, int width,
	...
	public void keyPressed(int key, char c) {
		if (hasFocus()) {
			...
			if (onTextChangeListener != null)
				onTextChangeListener.componentActivated(this);	// I added this
		}
	}
